...
public class FileService {
    ...
    public String file(String id, byte[] stream,String fileExtentionName, String urlName) {
        ...
        String imageUrl = fastDfsFileRepository.getUrlWithoutBase64(stream,
            StringUtils.isEmpty(fileExtentionName) ? "mp4" : fileExtentionName);
