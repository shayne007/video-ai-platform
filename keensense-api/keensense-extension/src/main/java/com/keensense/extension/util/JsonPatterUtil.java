...
public class JsonPatterUtil {
    ...
    public static final String TYPE_PERSON_FACE_PATTER = "^[1,3]{1}$";
    public static final String ID_PATTER = "^.{1,64}$";
    public static final String NAME_PATTER = "^.{1,32}$";
    public static final String DATE_PATTER = "[0-9]{4}[0-9]{2}[0-9]{2}[0-9]{2}[0-9]{2}[0-9]{2}";
    public static final Float SEARCH_THRESHOLD_DEFAULT_VALUE = 0.75f;
    public static final Integer SEARCH_MAXSIZE_DEFAULT_VALUE = 10;
    public static final String TRAIL_SOURCE_DEFAULT_VALUE = "1,2";
