...
public class QstBodySdkInvokeImpl implements IBodySdkInvoke {
    ...
    @Override
    public Var getPicAnalyzeOne(int objType, String picture) throws VideoException {
        Var objexts = this.getPicAnalyze(objType, picture);
        if (null == objexts) {
...
//            throw new VideoException(SdkExceptionConst.FAIL_CODE,retMsg);
     ...
     */
    @Override
    public Var getSimilars(int objType, String regIds, String feature,
    ...
    @Override
    public Var getSimilars(int objType, String regIds, String feature, Float threshold, int maxResult,
