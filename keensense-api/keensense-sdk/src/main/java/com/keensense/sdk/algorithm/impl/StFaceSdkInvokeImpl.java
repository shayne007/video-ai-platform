...
//		}
	...
	@Override
	public Map<String,Object> getPicAnalyze(String picture) {
...
//		}
	...
	@Override
	public Map<String,Object> getPicAnalyzeOne(String picture) {
...
//		}
	...
	@Override
	public Map<String,Object> getSimilars(String regIds, String feature, float threshold, int maxResult) {
		Map<String,String> paramMap = new HashMap<>();
		paramMap.put("feature", feature);
