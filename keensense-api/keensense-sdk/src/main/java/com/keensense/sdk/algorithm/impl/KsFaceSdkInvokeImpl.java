...
public class KsFaceSdkInvokeImpl implements IFaceSdkInvoke
{
    ...
    {
        this.baseUrl = param.get("faceServiceUrl") + FaceConstant.KSAPP_VERSION;
    }
...
//        return respVar.getString("id");
    ...
    public String delFaceFromLib(String repoId, String featureId) throws VideoException {
        ...
        if (StringUtils.isNotEmpty(resp) && resp.contains("NotFound"))
        {
...
//        return respVar.getString("featureData");
     ...
     */
    @Override
    public Map<String,Object> getSimilars(String regIds, String feature, float threshold,
...
//        return sort(resp);
    ...
    public Map<String,Object> sort(String json) {
        ...
        return JSONObject.parseObject(results.toJSONString());
    }
