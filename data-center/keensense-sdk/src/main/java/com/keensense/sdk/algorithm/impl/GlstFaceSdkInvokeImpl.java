...
public class GlstFaceSdkInvokeImpl implements IFaceSdkInvoke {
    ...
    public void initParams(Map<String,Object> param) {
        ...
        faceGlstTempPath = (String) param.get("faceGlstTempPath");
...
//        return resultVar;
    ...
    @Override
    public Map<String,Object> getSimilars(String regIds, String feature, float threshold, int maxResult, String startTime,
