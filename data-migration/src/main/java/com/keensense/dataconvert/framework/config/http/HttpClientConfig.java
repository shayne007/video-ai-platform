 ...
 * @Package：com.keensense.dataconvert.framework.config.http
 * @Description： <p> HttpClientConfig  - 好像无效果 [先注释]</p>
 * @Author： - Jason
 * @CreatTime：2019/7/31 - 14:47
 * @Modify By：
 * @ModifyTime： 2019/7/31
 * @Modify marker：
 */
//@Configuration
//@PropertySources(value = {@PropertySource(ConfigPathConstant.CONFIG_HTTP_CLIENT_PATH)})
