 ...
 * @Description： <p> RedisService </p>
 * @Author： - Jason
 * @CreatTime：2019/7/24 - 15:48
 * @Modify By：
...
public interface RedisService {
     ...
     */
	Boolean set(String key, String value) throws SystemException;


    /**
     * 保存stringKey 利用redis 的自增属性 来统计数据 add 20190403 by WuBin
     * @param key
     * @param value
     * @param expire
     * @return
     * @throws SystemException
     */
    Boolean set(String key, Object value, int expire) throws SystemException;
     ...
     * @throws SystemException
     */
	String type(String key) throws SystemException;
     ...
     * @throws SystemException
     */
	Long sadd(String key, String member, int expire) throws SystemException;
