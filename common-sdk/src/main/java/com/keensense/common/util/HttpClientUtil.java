...
public class HttpClientUtil {
    ...
    public static String get(String url, String param, Integer timeout, String encode) {
        ...
        try {
            ...
            log.error("http 请求地址错误:" + url + param);
        } finally {
            // 关闭连接,释放资源
            try {
                httpclient.close();
    ...
    public static void main(String[] args) throws Exception {
        String url = "http://192.168.0.63:9999/VIID/Faces?Faces.DeviceID=1562582932859&Faces.PageRecordNum=1000&Faces.RecordStartNo=1";
        String string = HttpClientUtil.get(url,null,null,null);
