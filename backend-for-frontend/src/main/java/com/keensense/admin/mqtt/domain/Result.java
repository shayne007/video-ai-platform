...
public abstract class Result {
    ...
    private Float faceQuality = 1.0f;

    /**
     * 人形质量，取值范围[0,1]，1代表最高质量
     */
    @JSONField(name= "BodyQuality")
    private Float bodyQuality = 1.0f;

    /**
     * 人脸特征 Bucket ID: -1是没有
     */
    @JSONField(name= "FaceBucketId")
    ...
    private String assistSnapshot;

    /**
     * 特征数据
     */
    @JSONField(name= "FeatureObject")
    private String featureObject;
    ...
    @JSONField(name= "messagetTime", format = "yyyy-MM-dd HH:mm:ss")
    private Date messagetTime;

    @JSONField(name= "messageKind")
