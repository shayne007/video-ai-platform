...
public class FtpHttpGetUtils {
    ...
    public static String getHttp(String ipAddress, String serviceName, String param) {
        ...
        httpClient.getParams().setSoTimeout(DbPropUtil.getInt("ftp_server_timeout", 20000));
        ...
        try {
            ...
            log.error(uuid + " SocketTimeoutException");
            responseMsg = "";
        } catch (HttpException e) {
            log.error(uuid + " HttpException");
//            e.printStackTrace();
        } catch (IOException e) {
            log.error(uuid + " IOException");
        } catch (Exception e) {
