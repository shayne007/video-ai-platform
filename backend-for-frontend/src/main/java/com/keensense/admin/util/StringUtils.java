...
//		return df.format(bigDecimal1);
	...
	/**
	 * 细类属性字符串转成code/name的Map类型
	 * @param str
	 * @return
	 */
	public static Map<String, String> splitEnumerationCodeForName(String str) {
	...
	/**
	 * 细类属性字符串转成name/code的Map类型
	 * @param str
	 * @return
	 */
	public static Map<String, String> splitEnumerationNameForCode(String str) {
		Map<String, String> map = new HashMap<>();
		String[] strArray = str.split("/");
		for (int i=0; i+1 < strArray.length; i+=2) {
